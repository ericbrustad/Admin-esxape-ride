      ...
      <div style={{ border:'1px solid #1f2b2f', borderRadius:10, padding:12, marginBottom:12, background:'#071014' }}>
        ...
        >
          ...
          <div style={{ marginTop:10 }}>
            {selectedMediaUrl ? (
              <div style={{ border:'1px solid #233236', borderRadius:10, overflow:'hidden', background:'#071018', padding:selectedMediaType==='audio' ? 12 : 0 }}>
                {selectedMediaType === 'image' || selectedMediaType === 'gif' ? (
                  <img src={selectedMediaUrl} alt="selected response" style={{ width:'100%', maxHeight:220, objectFit:'cover' }} />
                ) : selectedMediaType === 'video' ? (
                  <video src={selectedMediaUrl} style={{ width:'100%', maxHeight:240 }} controls muted />
