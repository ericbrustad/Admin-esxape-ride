...
ChatGPT said:
You said:
do not use canvas. this is a long file.  this is the index.js and media tab you will need to update and provide to e in a full file without and other changes to the game or look. if you want the look of the new page you have provided that would be fine but it would need a media pool tab to access it. i want the media tab to stay the same. please update this file with the needed changes to work. review this and continue carefully. do not make mistakes. import React, { useEffect, useRef, useState } from 'react';  
import TestLauncher from '../components/TestLauncher';
