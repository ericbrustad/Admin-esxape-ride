...
- 2025-10-17 — Disable legacy game deployment via Vercel ignore. Commit: (pending HEAD)
  - Direct links: `.vercelignore`
  - Notes: Adds a repository-level `.vercelignore` that omits the `game/` Next.js app from production builds so the dashboard is the only project deployed, keeping the game folder effectively off. Note to review @ 2025-10-17 10:59:21Z.
