...
export const ADMIN_THEME = {
  panelBg: 'var(--appearance-panel-bg, var(--admin-panel-bg))',
  panelBorder: 'var(--appearance-panel-border, var(--admin-panel-border))',
  panelShadow: 'var(--appearance-panel-shadow, var(--admin-panel-shadow))',
  surfaceGlass: 'rgba(14, 23, 35, 0.72)',
  surfaceRaised: 'rgba(11, 21, 32, 0.82)',
  surfaceSunken: 'rgba(8, 14, 23, 0.78)',
  surfaceAccent: 'rgba(59, 130, 246, 0.18)',
  successSurface: 'rgba(34, 197, 94, 0.14)',
  successText: '#a7f3d0',
  dangerSurface: 'rgba(239, 68, 68, 0.14)',
  textPrimary: 'var(--appearance-font-color, var(--admin-body-color))',
  textMuted: 'var(--admin-muted)',
  inputBg: 'var(--admin-input-bg)',
  inputBorder: 'var(--admin-input-border)',
  inputColor: 'var(--admin-input-color)',
  borderSoft: '1px solid var(--admin-border-soft)',
  borderSoftColor: 'var(--admin-border-soft)',
  accent: 'var(--admin-accent)',
  buttonBg: 'var(--admin-button-bg)',
  buttonBorder: 'var(--admin-button-border)',
  buttonColor: 'var(--admin-button-color)',
  glassSheen: 'var(--admin-glass-sheen)',
};
