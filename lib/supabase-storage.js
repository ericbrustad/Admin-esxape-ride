...
async function uploadObject(bucket, objectPath, body, { contentType = 'application/octet-stream', upsert = false } = {}) {
  ...
  const response = await fetch(targetUrl, {
    ...
    headers: {
      ...
      apikey: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFndGNjbnhmdWViaXJyY2VueGRuIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MDU1MTEyMCwiZXhwIjoyMDc2MTI3MTIwfQ.sEruJONq7Uz8vSIOBW7_OIin39qzB7abd6neB4Lwk68,
